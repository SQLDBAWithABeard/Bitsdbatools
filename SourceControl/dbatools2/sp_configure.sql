...
EXEC sp_configure 'ADR cleaner retry timeout (min)' , 120;
EXEC sp_configure 'ADR Preallocation Factor' , 4;
EXEC sp_configure 'version high part of SQL Server' , 0;
EXEC sp_configure 'version low part of SQL Server' , 0;
