$Bolton = Get-DbaInstance  -SqlInstance 'Rob-XPS\Bolton'
$SQL2016 = Get-DbaInstance  -SqlInstance 'Rob-XPS\SQL2016'
$cred = Import-Clixml C:\MSSQL\sa.cred 
$LinuxBolton = Get-DbaInstance  -SqlInstance Bolton -Credential $cred
