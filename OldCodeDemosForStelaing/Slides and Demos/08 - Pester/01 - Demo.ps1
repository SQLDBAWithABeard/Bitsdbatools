...
Describe "Do things Exist" {
    Context "Servers" {
        ...
        It "The Server $LinuxHyperV returns a ping" {
            (Test-Connection $($LinuxHyperV) -Count 1 -Quiet -ErrorAction SilentlyContinue ) | Should Be $true
        }
        It "Laptop Operating System Version" {
